...
public class PantallaPrincipal extends javax.swing.JFrame {
    ...
    private void opBajaActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_opBajaActionPerformed
        PantallaBaja baja = new PantallaBaja(this,true);
        baja.setTbClientes(tbClientes);
        baja.setVisible(true);
    }//GEN-LAST:event_opBajaActionPerformed
